...
//        int[] testInt = {5,6,8,1,2,5,8};
//        int[] testInt2 = {5,6,8,1,2,5,8};
//        
//        BSTSet x = new BSTSet(testInt);
//        BSTSet y = new BSTSet(testInt2);
//        
//        System.out.println(x.isIn(5));
//        System.out.println(x.isIn(6));
//        x.add(20);
//        System.out.println(x.isIn(20));
//        System.out.println(x.remove(20));
//        
//        System.out.println(x.size());
//        System.out.println("---------------");
//        
//        BSTSet unionTest = x.union(y);
//        
//        System.out.println(x.isIn(1));
//        System.out.println(x.isIn(2));
//        System.out.println(x.isIn(5));
//        System.out.println(x.isIn(6));
//        System.out.println(x.isIn(8));
